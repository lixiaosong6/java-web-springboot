...
<title>欢迎登录</title>
    ...
    <script type="text/javascript" src="js/jui/jquery.easyui.min.js"></script>
    <link rel="stylesheet" href="js/jui/themes/default/easyui.css" type="text/css"></link>
    <link rel="stylesheet" href="js/jui/themes/icon.css" type="text/css"></link>
</head>
<body>
	<div align="center" style="margin-top: 80px;">
		...
		<div class="easyui-panel" title="登录" style="width:400px;padding:30px 70px 20px 70px">
			...
			<form id="loginForm" method="post" action="<c:url value="/loginIng"/>">
			...
			<div style="margin-bottom:10px">
			 ...
			 <div style="margin-bottom:20px">
				<span style="padding-right: 25px">
					<img src="<%=request.getContextPath()%>/captcha-image?t=Math.random()"  id="kaptchaImage"
							align="left" width="30%" height="40px"/>
				</span>
				<input name="captchaCode" class="easyui-textbox"
